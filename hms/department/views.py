...
def create_department(request):
    if request.method == 'POST':
        ...
        if department_name == '' or department_no == '' or department_head == '' or department_date == '' or department_status == '' or department_info == '':
            messages.error(request, 'Kindly fill all the input')
